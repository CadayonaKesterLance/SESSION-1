    ...
    <div class="session-container">
            ...
            <form action="" method="post">
                ...
                <div class="search-container">
                    ...
                    <input type="search" name="search" Id="search"
                        style="width: 370px; margin-left:2px; font-size: 18px;"
                        value="<?php echo htmlspecialchars(isset($_POST['search']) ? $_POST['search'] : '', ENT_QUOTES); ?>"
                        placeholder="Search...">
        ...
        WHERE assets.AssetNAME LIKE '%$searchTerm%'";
                    ...
                    <div class="table-container">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img src="img/Null-Item.png" height="60px" width="60px"
                                    ...
                                    <td>
                                        ...
                                        <a href="update.php? id=<?php echo $row['assetSN']; ?> "><i class="fas fa-pen"></i></a>
                                        <a href="#Edit"> <i class="fas fa-share-square"></i></a>
                                        <a href="#Edit"> <i class="fas fa-file"></i></a>
            ...
            <div>
                ...
                <a href="addAssets.php"><button class="round-button">+</button></a>
            </div>
        </div>
    </div>
                        ...
                        while ($row = $result2->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td style="width:100%;">
                                    ...
                                    <?php echo $row['AssetSN']; ?>
                                </td>
                                <td>
                                    <a href="#Edit"><i class="fas fa-pen" style="margin-right:10px"></i></a>
                                </td>
                            </tr>
                            <?php
                        }
