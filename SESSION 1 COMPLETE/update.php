...
if (isset($_POST['discard'])){
 echo "<script>alert('Update discarded.'); window.location='main.php';</script>";
}
...
if (isset($_POST['update'])) {
    ...
    if ($conn->query($sql1) and $conn->query($sql2) === TRUE) {
        echo "<script>alert('Data was updated successfully.'); window.location='main.php';</script>";
...
<div class="session-container1">
 <div class="container">
    <div class="AssetInfo">
        ...
        <a href="main.php"> <button  class="backbtn">Back</button></a><br>
    </div>
