...
if (isset($_POST['submit'])) {
    ...
    if ($conn->query($sql) and $conn->query($sql1) === TRUE) {
        echo "<script>alert('Data was created successfully.'); window.location='main.php';</script>";
...
<div class="session-container1">
 <div class="container">
    <div class="AssetInfo">
        ...
        <a href="main.php"> <button class="backbtn">Back</button></a>
    </div>
    <form action="" method="POST">
        ...
        <a href="main.php"><button class = "cancel">Cancel</button></a>
    </form>
</div>
</div>
